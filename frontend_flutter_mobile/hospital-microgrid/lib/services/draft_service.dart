...
class DraftService {
  ...
  static const String _draftFormA1Key = '${_draftKeyPrefix}form_a1';

  static const String _draftFormA2Key = '${_draftKeyPrefix}form_a2';

  static const String _draftFormA5Key = '${_draftKeyPrefix}form_a5';
